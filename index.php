<?php
define('API_KEY','255735417:AAEAHmKPfRsa7yBzQc9MQpsFPVbrTBD2MW0');
//----######------
...
//===========
$inch = file_get_contents("https://api.telegram.org/bot".API_KEY."/getChatMember?chat_id=@white_team&user_id=".$from_id);
    ...
    var_dump(
        makereq('editMessageText',[
            ...
            'reply_markup'=>json_encode([
                'inline_keyboard'=>[
                    [
                        ['text'=>"به کانال ما بپیوندید - Pease join to my channel",'url'=>"https://telegram.me/white_team"]
                    ]
                ]
            ])
        ])
    ...
    var_dump(
        makereq('editMessageText',[
            ...
            'reply_markup'=>json_encode([
                'inline_keyboard'=>[
                    [
                        ['text'=>"به کانال ما بپیوندید - Pleas join to my channel",'url'=>"https://telegram.me/white_team"]
                    ]
                ]
            ])
        ])
...
$token = $textmessage ;
	...
	$ok = $resultb["ok"];
		...
		file_get_contents("http://api.telegram.org/bot".255735417:AAEAHmKPfRsa7yBzQc9MQpsFPVbrTBD2MW0."/setwebhook?url=https://webhook/bots/198835395/index.php");
